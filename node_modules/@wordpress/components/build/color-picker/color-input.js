...
const ColorInput = ({
  ...
  switch (colorType) {
    case 'hsl':
      return (0, _element.createElement)(_hslInput.HslInput, {
        ...props
      });
    case 'rgb':
      return (0, _element.createElement)(_rgbInput.RgbInput, {
        ...props
      });
    default:
    case 'hex':
      return (0, _element.createElement)(_hexInput.HexInput, {
        ...props
      });
  }
};
