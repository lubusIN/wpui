 ...
 * ```
 */
export declare const MenuHeading: import("../utils/types.js").Component<MenuHeadingOptions<"h1">>;
export interface MenuHeadingOptions<T extends As = "h1"> extends HovercardHeadingOptions<T> {
    /**
...
export type MenuHeadingProps<T extends As = "h1"> = Props<MenuHeadingOptions<T>>;
