...
var _GTZQOSRGcjs = require('../__chunks/GTZQOSRG.cjs');


var _BPAMJRUFcjs = require('../__chunks/BPAMJRUF.cjs');
require('../__chunks/ZK5KHSMP.cjs');
...
var useToolbarInput = _CWY2PHPRcjs.createHook.call(void 0, 
  (_a) => {
    var _b = _a, { store } = _b, props = _72I2GWXFcjs.__objRest.call(void 0, _b, ["store"]);
    props = _GTZQOSRGcjs.useCompositeInput.call(void 0, _72I2GWXFcjs.__spreadValues.call(void 0, { store }, props));
    props = _BPAMJRUFcjs.useToolbarItem.call(void 0, _72I2GWXFcjs.__spreadValues.call(void 0, { store }, props));
    return props;
  }
);
var ToolbarInput = _CWY2PHPRcjs.createMemoComponent.call(void 0, 
  (props) => {
