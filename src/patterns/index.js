...
export { default as Feeds } from './Feed/data';
export { default as Forms } from './Form/data';
export { default as HeroSection } from './HeroSection/data';
...
export {default as Actionpanel2} from './New-patterns/data';
