    ...
    return (
        <HStack justify="center">
            <VStack alignment="left" spacing={8}>
                ...
                <HStack>
                    <Divider />
                    <Heading level={5}>Or continue with</Heading>
                    <Divider />
                </HStack>
