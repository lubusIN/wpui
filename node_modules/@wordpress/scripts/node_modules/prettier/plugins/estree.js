(function(f){function e(){var i=f();return i.default||i}if(typeof exports=="object"&&typeof module=="object")module.exports=e();else if(typeof define=="function"&&define.amd)define(e);else{var t=typeof globalThis<"u"?globalThis:typeof global<"u"?global:typeof self<"u"?self:this||{};t.prettierPlugins=t.prettierPlugins||{},t.prettierPlugins.estree=e()}})(function(){"use strict";var ia=Object.create;var mr=Object.defineProperty;var aa=Object.getOwnPropertyDescriptor;var oa=Object.getOwnPropertyNames;var pa=Object.getPrototypeOf,ca=Object.prototype.hasOwnProperty;var la=(e,t)=>()=>(t||e((t={exports:{}}).exports,t),t.exports),yr=(e,t)=>{for(var r in t)mr(e,r,{get:t[r],enumerable:!0})},Bs=(e,t,r,n)=>{if(t&&typeof t=="object"||typeof t=="function")for(let s of oa(t))!ca.call(e,s)&&s!==r&&mr(e,s,{get:()=>t[s],enumerable:!(n=aa(t,s))||n.enumerable});return e};var ma=(e,t,r)=>(r=e!=null?ia(pa(e)):{},Bs(t||!e||!e.__esModule?mr(r,"default",{value:e,enumerable:!0}):r,e)),ya=e=>Bs(mr({},"__esModule",{value:!0}),e);var bs=(e,t,r)=>{if(!t.has(e))throw TypeError("Cannot "+r)};var at=(e,t,r)=>(bs(e,t,"read from private field"),r?r.call(e):t.get(e)),Ps=(e,t,r)=>{if(t.has(e))throw TypeError("Cannot add the same private member more than once");t instanceof WeakSet?t.add(e):t.set(e,r)},ks=(e,t,r,n)=>(bs(e,t,"write to private field"),n?n.call(e,r):t.set(e,r),r);var Ki=la(Pt=>{"use strict";Object.defineProperty(Pt,"__esModule",{value:!0});Pt.extract=nl;Pt.parse=ul;Pt.parseWithComments=Hi;Pt.print=il;Pt.strip=sl;var Qc=/\*\/$/,Zc=/^\/\*\*?/,$i=/^\s*(\/\*\*?(.|\r?\n)*?\*\/)/,el=/(^|\s+)\/\/([^\r\n]*)/g,Wi=/^(\r?\n)+/,tl=/(?:^|\r?\n) *(@[^\r\n]*?) *\r?\n *(?![^@\r\n]*\/\/[^]*)([^@\r\n\s][^@\r\n]+?) *\r?\n/g,Yi=/(?:^|\r?\n) *@(\S+) *([^\r\n]*)/g,rl=/(\r?\n|^) *\* ?/g,Vi=[];function nl(e){let t=e.match($i);return t?t[0].trimLeft():""}function sl(e){let t=e.match($i);return t&&t[0]?e.substring(t[0].length):e}function ul(e){return Hi(e).pragmas}function Hi(e){let t=`
