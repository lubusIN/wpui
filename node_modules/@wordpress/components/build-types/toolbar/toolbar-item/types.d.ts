 ...
 */
import type { ReactElement, ReactNode, ElementType, HTMLAttributes, RefAttributes } from 'react';
export type ToolbarItemProps = Omit<HTMLAttributes<any>, 'children'> & {
     ...
     */
    children?: ReactNode | ((props: HTMLAttributes<any> & RefAttributes<any>) => ReactElement | null);
};
