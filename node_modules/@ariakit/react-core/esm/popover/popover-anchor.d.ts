 ...
 * ```
 */
export declare const usePopoverAnchor: import("../utils/types.js").Hook<PopoverAnchorOptions<"div">>;
/**
...
export type PopoverAnchorProps<T extends As = "div"> = Props<PopoverAnchorOptions<T>>;
