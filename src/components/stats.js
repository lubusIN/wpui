                ...
                <Card isBorderless isElevated style={{ width: '100%' }}>
                    <CardBody>
                        <HStack alignment="left" spacing={6}>
                            ...
                            ></Icon>
                            <VStack>
                                <Text size={20} variant="muted">Total subscribers</Text>
                                <HStack>
                ...
                <Card isBorderless isElevated style={{ width: '100%' }}>
                    <CardBody>
                        <HStack alignment="left" spacing={6}>
                            ...
                            ></Icon>
                            <VStack>
                                <Text size={20} variant="muted">Avg. Open Rate</Text>
                                <HStack>
                ...
                <Card isBorderless isElevated style={{ width: '100%' }}>
                    <CardBody>
                        <HStack alignment="left" spacing={6}>
                            ...
                            ></Icon>
                            <VStack>
                                <Text size={20} variant="muted">Avg. Click Rate</Text>
                                <HStack>
