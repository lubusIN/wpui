...
var _N2KSMVA7cjs = require('../__chunks/N2KSMVA7.cjs');
require('../__chunks/4K6QJIPX.cjs');
...
// src/hovercard/hovercard-arrow.ts
var useHovercardArrow = _CWY2PHPRcjs.createHook.call(void 0, (props) => {
  props = _N2KSMVA7cjs.usePopoverArrow.call(void 0, props);
  return props;
});
var HovercardArrow = _CWY2PHPRcjs.createComponent.call(void 0, 
  (props) => {
