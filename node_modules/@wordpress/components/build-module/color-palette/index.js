...
function UnforwardedColorPalette(props, forwardedRef) {
  ...
  const actions = !!clearable && createElement(CircularOptionPicker.ButtonAction, {
    onClick: clearColor
  }, __('Clear'));
  let metaProps;
  if (asButtons) {
  ...
  }), createElement(CircularOptionPicker, {
    ...metaProps,
    actions: actions,
    options: hasMultipleColorOrigins ? createElement(MultiplePalettes, {
      ...paletteCommonProps,
      headingLevel: headingLevel,
      colors: colors,
      value: value
    }) : createElement(SinglePalette, {
      ...paletteCommonProps,
      colors: colors,
      value: value
    })
