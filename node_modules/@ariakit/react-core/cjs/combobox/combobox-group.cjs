...
var _W7ZAKGYJcjs = require('../__chunks/W7ZAKGYJ.cjs');
require('../__chunks/IY72JWXE.cjs');
...
var useComboboxGroup = _CWY2PHPRcjs.createHook.call(void 0, (props) => {
  props = _W7ZAKGYJcjs.useCompositeGroup.call(void 0, props);
  return props;
});
var ComboboxGroup = _CWY2PHPRcjs.createComponent.call(void 0, (props) => {
