...
export type CategorySelectProps = Pick<TreeSelectProps, 'label' | 'noOptionLabel'> & {
    categoriesList: Category[];
    onChange: (newCategory: string) => void;
    selectedCategoryId?: Category['id'];
};
export type AuthorSelectProps = Pick<TreeSelectProps, 'label' | 'noOptionLabel'> & {
    authorList?: Author[];
...
export type QueryControlsWithSingleCategorySelectionProps = BaseQueryControlsProps & {
    /**
...
export type QueryControlsWithMultipleCategorySelectionProps = BaseQueryControlsProps & {
    /**
...
export type QueryControlsProps = QueryControlsWithSingleCategorySelectionProps | QueryControlsWithMultipleCategorySelectionProps;
export {};
