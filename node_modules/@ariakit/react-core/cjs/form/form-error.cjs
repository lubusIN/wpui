...
var _ETK4FMZHcjs = require('../__chunks/ETK4FMZH.cjs');
...
var useFormError = _CWY2PHPRcjs.createHook.call(void 0, 
  (_a) => {
    var _b = _a, { store, name: nameProp, getItem: getItemProp } = _b, props = _72I2GWXFcjs.__objRest.call(void 0, _b, ["store", "name", "getItem"]);
    ...
    const getItem = _react.useCallback.call(void 0, 
      (item) => {
        const nextItem = _72I2GWXFcjs.__spreadProps.call(void 0, _72I2GWXFcjs.__spreadValues.call(void 0, {}, item), { id: id || item.id, name, type: "error" });
        if (getItemProp) {
    ...
    props = _ETK4FMZHcjs.useCollectionItem.call(void 0, _72I2GWXFcjs.__spreadProps.call(void 0, _72I2GWXFcjs.__spreadValues.call(void 0, { store }, props), { getItem }));
    return props;
  }
);
var FormError = _CWY2PHPRcjs.createMemoComponent.call(void 0, (props) => {
