...
export type FocalPointPickerProps = Pick<BaseControlProps, 'help' | 'hideLabelFromVision' | 'label'> & {
    /**
...
export type FocalPointPickerMediaProps = Pick<VideoHTMLAttributes<HTMLVideoElement>, 'autoPlay' | 'muted'> & {
    alt: string;
