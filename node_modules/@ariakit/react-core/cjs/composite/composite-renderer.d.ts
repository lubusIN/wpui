...
import type { CollectionRendererBaseItemProps, CollectionRendererItem, CollectionRendererItemObject, CollectionRendererItemProps, CollectionRendererOptions } from "../collection/collection-renderer.js";
...
type ItemProps<T extends Item, P extends BaseItemProps = BaseItemProps> = CollectionRendererItemProps<T, P>;
export declare function useCompositeRenderer<T extends Item = any>({ store, orientation: orientationProp, persistentIndices: persistentIndicesProp, children: renderItem, "aria-setsize": ariaSetSize, "aria-posinset": ariaPosInSet, ...props }: CompositeRendererProps<T>): {
    ...
    render?: import("react").ReactElement<any, string | import("react").JSXElementConstructor<any>> | import("../utils/types.js").RenderProp | undefined;
};
export { getCollectionRendererItem as getCompositeRendererItem, getCollectionRendererItemId as getCompositeRendererItemId, };
...
export type CompositeRendererItemProps<T extends Item, P extends BaseItemProps = BaseItemProps> = ItemProps<T, P>;
export declare const CompositeRenderer: <T extends Item = any>(props: CompositeRendererProps<T>) => import("react").ReactElement<any, string | import("react").JSXElementConstructor<any>>;
export interface CompositeRendererOptions<T extends Item = any> extends Omit<CollectionRendererOptions<T>, "store" | "children"> {
    /**
     ...
     * provided.
     */
    store?: CompositeStore<T extends CollectionStoreItem ? T : CompositeStoreItem>;
    /**
...
export interface CompositeRendererProps<T extends Item = any> extends Omit<ComponentPropsWithRef<"div">, "children">, CompositeRendererOptions<T> {
}
