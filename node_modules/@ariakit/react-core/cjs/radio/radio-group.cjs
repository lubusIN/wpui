...
var _7JKSDWVFcjs = require('../__chunks/7JKSDWVF.cjs');
...
var useRadioGroup = _CWY2PHPRcjs.createHook.call(void 0, 
  (_a) => {
    var _b = _a, { store } = _b, props = _72I2GWXFcjs.__objRest.call(void 0, _b, ["store"]);
    props = _5WLTMVVQcjs.useWrapElement.call(void 0, 
      props,
      (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _7JKSDWVFcjs.RadioContext.Provider, { value: store, children: element }),
      [store]
    );
    props = _72I2GWXFcjs.__spreadValues.call(void 0, {
      role: "radiogroup"
    }, props);
    props = _A764D2YKcjs.useComposite.call(void 0, _72I2GWXFcjs.__spreadValues.call(void 0, { store }, props));
    return props;
  }
);
var RadioGroup = _CWY2PHPRcjs.createComponent.call(void 0, (props) => {
